...
double cal(double a, double b, double q)
{
    q = (pi/180)*q;
    return (a*b)/sqrt((a*a*cos(q)*cos(q) + b*b*sin(q)*sin(q)));
}
...
void display(){
	...
	****************************/
    ...
    glColor3f(1, 0, 0);
    glRotatef(angle,0,0,1);
    glTranslatef(cal(110, 150, angle),0,0);
    glRotatef(2*angle,0,0,1);
    drawSphere(10, 24, 20);
    glPopMatrix();
    ...
    glColor3f(0, 1, 0);
    glRotatef(angle,0,0,1);
    glTranslatef(cal(210, 250, angle),0,0);
    glRotatef(2*angle,0,0,1);
    drawSphere(15, 24, 20);
    glPopMatrix();
    ...
    glColor3f(1, 1, 0);
    glRotatef(angle,0,0,1);
    glTranslatef(cal(410, 450, angle),0,0);
    glRotatef(2*angle,0,0,1);
    drawSphere(20, 24, 20);
    glPushMatrix();
        glColor3f(1, 1, 1);
